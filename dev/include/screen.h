...
#define TODO ({;PANIC("Still working...");})
...
void screen_set_color(uint8_t fc, uint8_t bc);
...
//Bad naming at begining...
#define screenSetColor screen_set_color

#define screenClear screen_clear
#endif //W2_SCREEN_H
